...
app.get('/bench/:numberOfRequests/:concurrency', (req, res) => {
  ...
  exec(`ab -n ${numberOfRequests} -c ${concurrency} http://localhost:3000/massive`, (error, stdout, stderr) => {
    ...
    It is not a synthetic benchmark but a real use case extremelly common in the real world. 
